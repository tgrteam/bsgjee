...
{	
    ...
    public class BSG_OracleJEE_edit_form : ProxyBaseClass
	{
            ...
            , BSGSourceFile src)
        {
            ...
            src.FileName = "edit-" + this.IBSBSGClass.MHIBSNameLowerCase + @"-form";
...
<title>Edit " + this.IBSBSGClass.MHIBSNameJavaCase + @" page</title>
</head>");
...
<body>");
            ...
            this.Src.AddLn(@"
<h1>Edit " + this.IBSBSGClass.MHIBSNameJavaCase + @" page</h1>
<p>Here you can edit the existing " + this.IBSBSGClass.MHIBSNameJavaCase + @".</p>
<p>${message}</p>");

            this.Src.AddLn(@"
<form:form method=" 
                + PP() + @"POST" + PP() 
                + @" commandName=" + PP() + @"" + this.IBSBSGClass.MHIBSNameJavaCase + @"" + PP() 
                + @" action=" + PP() + @"${pageContext.request.contextPath}/" 
                + this.IBSBSGClass.MHIBSNameLowerCase
                + @"/edit/${" + this.IBSBSGClass.MHIBSNameJavaCase 
                + @"." 
                + this.IBSBSGClass.MHIBSChoosedDataSetFields.FHIBSPrimaryKey.BSGFieldItem.Name 
                + @"}.html" + PP() + @">
");

            this.Src.AddLn(@"<table>
<tbody>
");
        }
...
");
            ...
            this.Src.AddLn(@"
    <tr>
		<td><input type=" + PP() + @"submit" + PP() + @" value=" + PP() + @"Edit" + PP() + @" /></td>
		<td></td>
	</tr>
");
